 ...
 * @param {boolean} isPart - boolean indicating whether an entire object
 * or a part is being put
 ...
 * @return {undefined}
 */
export function dataStore(isPart, objectContext, cipherBundle, stream, size,
    streamingV4Params, backendInfo, log, cb) {
    const dataStream = prepareStream(stream, streamingV4Params, log, cb);
    data.put(isPart, cipherBundle, dataStream, size, objectContext,
